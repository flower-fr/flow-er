...
export default class ModalListForm extends View
{
    constructor({ controller, context, section, properties, where, id })
    {
        super({ controller })
    ...
    render = () =>
    {
        const context = this.context, section = this.section, properties = this.properties, where = this.where, id = this.id
