            ...
            <div class="modal-body">
                ...
                <section class="summary-section">
                    <div class="form-outline my-3" data-mdb-input-init="" data-mdb-input-initialized="true">
                        <input type="text" class="form-control form-control-sm calendar-summary-input fl-modal-form-input" data-fl-property="summary" data-fl-type="input" required>
                        <label class="form-label" style="margin-left: 0px;">Résumé</label>
                    </div>
                </section>
                <div class="form-outline my-3" data-mdb-input-init="" data-mdb-input-initialized="true">
                    <textarea type="text" class="form-control form-control-sm fl-modal-form-input" data-fl-property="description" data-fl-type="textarea"></textarea>
                ...
                <section class="long-event-section">
                    <div class="form-outline my-3 fl-date-outline" data-fl-container="flModal" data-mdb-datepicker-init data-mdb-input-init data-mdb-inline="true"> 
                        <input type="text" class="form-control form-control-sm calendar-date-input active form-icon-trailing fl-modal-form-input" data-fl-property="date" data-fl-type="date" value="${ context.decodeDate(moment().add(1, "days").format("YYYY-MM-DD")) }" required>
                        <label class="form-label" style="margin-left: 0px;">
                ...
                <section class="long-event-section">
                    <div class="form-outline my-3 fl-time-outline" data-fl-container="flModal" data-mdb-datepicker-init data-mdb-input-init> 
                        <input type="text" class="form-control form-control-sm fl-modal-form-input" data-fl-property="time" data-fl-type="time">
                        <label class="form-label" style="margin-left: 0px;">
                ...
                <section class="account_id-section">
                    <div class="form-outline my-3" data-fl-container="flModal" data-fl-values="${ account_idValues.join(",") }" data-mdb-input-init="" data-mdb-input-initialized="true">
                        <input type="text" class="form-control form-control-sm fl-modal-form-input" data-fl-property="account_id" data-fl-type="input" data-fl-values="${ account_idValues.join(",") }" data-fl-ids="${ accountIds.join(",") }">
