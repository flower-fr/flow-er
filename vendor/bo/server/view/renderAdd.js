...
const renderAdd = (context, entity, view, properties, where, formJwt) => {
    ...
    return `<form class="was-validated" id="tabForm">
        ...
        <div class="my-3">
            ...
            <div class="form-group row submitDiv">
                ...
                <div class="col-sm-7">
                    <input name="submit" type="submit" id="upSubmitButton" class="btn btn-warning submitButton" value="${context.translate("Add")}">
                </div>
            </div>
