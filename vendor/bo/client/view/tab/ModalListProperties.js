...
export default class ModalListProperties extends View
{
    constructor({ controller, context, entity, section, config, properties, row })
    {
        super({ controller })
    ...
    render = () =>
    {
        const context = this.context, entity = this.entity, section = this.section, modalListConfig = this.config, properties = this.properties, row = this.row
