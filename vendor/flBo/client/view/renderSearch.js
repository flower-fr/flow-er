...
const renderFilterDateTime = (context, propertyId, property, data) => 
{
    ...
    return `<div class="form-floating form-outline fl-search-date-outline mb-1" data-mdb-datepicker-init data-mdb-input-init data-mdb-inline="true">
            ...
            <div class="form-floating form-outline fl-search-date-outline mb-3" data-mdb-datepicker-init data-mdb-input-init data-mdb-inline="true">
...
const renderFilterSelect = (context, propertyId, property, options, where) => 
{
    ...
    <div class="form-floating mb-3">
        <select class="form-select fl-search-item fl-search-select" data-property-id="${propertyId}" data-mdb-size="sm" data-mdb-select-init="" id="flSearch-${propertyId}" multiple>
            ${renderModalities()}
        </select>
...
const renderFilterInput = (context, propertyId, property, options, properties) => 
{
    ...
    return `
        <div class="form-floating form-outline fl-search-form-outline mb-3" data-mdb-input-init data-values="${ values.join(",") }">
