const renderModalListForm = ({ context, entity, view, id }, { modalListFormConfig, properties, row, isDeletable, where, formJwt }) => {
    ...
    const renderSectionMenu = () => {
        ...
        for (let sectionId of Object.keys(modalListFormConfig.layout)) {
            const section = modalListFormConfig.layout[sectionId]
            if (section.labels) {
